            ...
            <ScrollView className="flex-1">
                ...
                <View className="bg-white mt-4 mx-4 rounded-lg shadow-sm">
                    ...
                    <View className="px-4 py-3">
                        ...
                        <View className="flex-row items-center justify-between py-3 border-t border-gray-100">
                            <View className="flex-1">
                                <Text className="text-base font-medium text-gray-900">Mode Gelap</Text>
                                <Text className="text-sm text-gray-500">Tampilan gelap untuk mata</Text>
                            </View>
                            <Switch
                ...
                <View className="bg-white mt-4 mx-4 rounded-lg shadow-sm">
                    ...
                    <View className="px-4 py-3">
                        ...
                        <View className="flex-row items-center justify-between py-3 border-t border-gray-100">
                            <View className="flex-1">
                                <Text className="text-base font-medium text-gray-900">Getaran</Text>
                                <Text className="text-sm text-gray-500">Aktifkan getaran notifikasi</Text>
                            </View>
                            <Switch
