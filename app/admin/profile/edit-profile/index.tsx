...
export default function EditProfile() {
    const handleEditAdminProfile = () => {
        router.push('/admin/profile/edit-profile/edit')
    }

    const handleEditCompanyInfo = () => {
        router.push('/admin/profile/edit-profile/information')
    }
            ...
            >
                ...
                <View className="px-6 mb-8">
                    ...
                    <View className="space-y-4">
                        {/* Edit Admin Profile */}
                        <TouchableOpacity
                            onPress={handleEditAdminProfile}
                        ...
                        >
                            <View className="flex-row items-center p-6">
                                ...
                                <View className="flex-1">
                                    <Text className="text-lg font-bold text-gray-900 mb-1">Profil Admin</Text>
                                    <Text className="text-gray-600">Edit informasi pribadi admin</Text>
                                </View>
